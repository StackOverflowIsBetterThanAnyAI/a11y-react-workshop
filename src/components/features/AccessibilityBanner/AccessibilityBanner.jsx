            ...
            <div className="px-6 py-8 md:px-12 md:py-12">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-blue-50 mb-6 max-w-2xl mx-auto">
                        Our products are designed for everyone, including people
                        with motor, visual, hearing, and cognitive disabilities.
                        Accessibility matters because it ensures equal access to
