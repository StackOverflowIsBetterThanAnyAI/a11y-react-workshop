    ...
    return (
        <>
            ...
            >
                ...
                <p className="mb-6">
                    Explore our accessible products designed for everyone,
                    ...
                    {filteredProducts.map((product) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="bg-blue-500 text-white w-full px-3 py-1.5 rounded text-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                aria-label={"Add"}
                            >
                                Add to Cart
                            </button>
