...
const SearchAndFilter = ({ onSearchChange, onFilterChange }) => {
    ...
    const handleFilterToggle = (filter) => {
        ...
        const categories = newFilters
            .filter((f) => f.type === "category")
            .map((f) => f.id);
        const prices = newFilters
                ...
                <div className="relative flex-grow">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            id="product-search"
                            name="product-search"
                            className="block w-full pl-12 pr-10 py-3 border text-zinc-300 border-gray-200 rounded-md shadow-sm bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-blue-400 focus:border-blue-400"
